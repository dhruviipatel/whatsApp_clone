...
const Color tealGreenColor = Color(0xff128C7E);
const Color tealDarkGreenColor = Color(0xff075E54);
const Color tealLightGreenColor = Color(0xff25D366);
const Color lightgreenColor = Color.fromARGB(255, 158, 214, 207);
const Color mychatcolor = Color(0xffdcf8c6);
/////
